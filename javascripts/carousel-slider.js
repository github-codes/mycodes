(function($) {
$.fn.jCarouselLite = function(o) {o = $.extend({}, o || {});
return this.each(function() {
var running = false, animCss=o.vertical?"top":"left", sizeCss=o.vertical?"height":"width";
var div = $(this), ul = $("ul:first", div), tLi = $(".sli", ul), tl = tLi.size(), v = o.visible;
if(o.circular) {ul.prepend(tLi.slice(tl-v-1+1).clone())
.append(tLi.slice(0,v).clone()); o.start += v;}
var li = $(".sli", ul), itemLength = li.size(), curr = o.start; div.css("visibility", "visible");
li.css({overflow: "hidden", float: o.vertical ? "none" : "left"});
ul.css({ padding: "0", "z-index": "9"});
div.css({overflow: "hidden", "z-index": "99"});
...
$(val).click(function() {return go(o.circular ? o.visible+i : i);});});
...
curr = to==itemLength-v+1 ? v+1 : v+o.scroll;} else curr = to;} 
...
(curr+o.scroll > itemLength-v && o.btnNext) || []).addClass("disabled");}} return false;};});};
